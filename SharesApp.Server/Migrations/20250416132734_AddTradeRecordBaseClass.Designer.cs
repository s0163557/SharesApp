...
namespace SharesApp.Server.Migrations
{
    ...
    [Migration("20250416132734_AddTradeRecordBaseClass")]
    partial class AddTradeRecordBaseClass
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SharesApp.Server.Models.SecurityTradeRecordByMonth", b =>
                {
                    b.Property<int>("SecurityTradeRecordId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SharesApp.Server.Models.SecurityTradeRecordByMonth", b =>
                {
                    b.HasOne("SharesApp.Server.Models.SecurityInfo", "SecurityInfo")
                        .WithMany("SecurityTradeRecordsByMonth")
                        .HasForeignKey("SecurityInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SharesApp.Server.Models.SecurityInfo", b =>
                {
                    ...
                    b.Navigation("SecurityTradeRecordsByMonth");
